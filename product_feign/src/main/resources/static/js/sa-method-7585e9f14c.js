(function(win) {
    win.saMethod = {
        ...
        'roomCustomizedSubmitBtn':function (page,btn) {
            sa.track('roomCustomizedSubmitBtn', {
                'page':page,
                'btn':btn
            })
        },
        ...
        'seckillBtnClick': function (btn) {//秒杀活动-提交心愿
            sa.track('seckillBtnClick', {
                'btn_click':btn
            })
        },
        'seckillBannerClick': function (btn) {//秒杀活动-banner图
            sa.track('seckillBannerClick', {
                'btn_click':btn
            })
        },
        'seckillOrderBtn': function (btn) {//秒杀活动-约看
            sa.track('seckillOrderBtn', {
                'btn_click':btn
            })
        },
        'TemplateIntelligenceLoading': function(page) { // 专题模板2loading
            sa.track('TemplateIntelligenceLoading', {
                'page':page
            })
        },
        'OldRecommandClickMethod': function(name) { // 专题模板2loading
            sa.track('OldRecommandClickMethod', {
                'btn_name':name
            })
        }
    }
